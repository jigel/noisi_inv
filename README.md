...
Additionally, install [instaseis](http://instaseis.net/), if you plan to use it for Green's functions (`conda install instaseis`). If there are issues installing instaseis with conda, cloning the github repository and installing that usually works: https://github.com/sstaehler/instaseis. 
